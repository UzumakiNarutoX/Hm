...
from Hiro import REDLIONS, dispatcher
...
from Hiro.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from Hiro.modules.log_channel import loggable
from Hiro.utils.admin_rights import (
    user_can_changeinfo,
    user_can_pin,
    user_can_promote,
)
