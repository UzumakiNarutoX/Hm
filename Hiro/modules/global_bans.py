...
import Hiro.modules.sql.global_bans_sql as sql
from Hiro import (
    DEV_USERS,
    EVENT_LOGS,
    FAFNIRS,
...
from Hiro.modules.helper_funcs.misc import send_to_list
from Hiro.modules.sql.users_sql import get_user_com_chats
