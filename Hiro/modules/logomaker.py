...
async def lego(event):
    ...
    try:
        ...
        img = Image.open("./Hiro/resources/blackbg.jpg")

        draw = ImageDraw.Draw(img)

        image_widthz, image_heightz = img.size

        font = ImageFont.truetype("./Hiro/resources/Chopsic.otf", 330)
...
async def lego(event):
    ...
    try:
        ...
        font = ImageFont.truetype("./Hiro/resources/Maghrib.ttf", 1000)
